...
<div id="main-container-posicion">
	...
	<div id="button-mensajedocente" class="main-container-submit" onclick="abrirmensajealumno()"><img src="../images/mensajealumno.png">
		<script type="text/javascript" src="../js/cambio.js"></script></div>
	<div id="button-mensajepersonal" class="main-container-submit" onclick="abrirmensajeapersonal2()"><img src="../images/mensajeadepto.png" onclick="abrir()">
		<script type="text/javascript" src="../js/cambio.js"></script></div>
	<div id="button-mensajesdocente" class="main-container-submit" onclick="abrirmensajesalumno()"><img src="../images/mensajesalumno.png">
		<script type="text/javascript" src="../js/cambio.js"></script></div>
	<div id="button-mensajespersonal" class="main-container-submit" onclick="abrirmensajespersonal2()"><img src="../images/mensajededepto.png">
		<script type="text/javascript" src="../js/cambio.js"></script></div>
