...
include '../php/conexion.php';
    ...
    $con2 = conectar();
	$consulta2="SELECT * FROM profesores WHERE ESTATUSBORRAR='1';";
...
<html>
<head>
	<title>Mensaje a Docente | Secundaria Oficial 0986 "Juan Rulfo"</title>
	<link rel="stylesheet" type="text/css" href="../css/estiloenviodocente.css?n=1">
...
<div id="main-container-posicion">
	...
	<form method="POST" action="../php/enviodocente.php" id="main-form" autocomplete="off" enctype="multipart/form-data">
		<div id="titulo-form">
			<label>Mensaje a Docente</label>
		</div>
		<div id="main-container-registro-form-primary">
			<label for="docente" id="etiqueta-docente">Destinatario</label>
		<select name="docente" id="docente" class="form-elements">
			<option value="">Seleciona un Docente</option>
			<?php foreach ($resultado2 as $opciones2): ?>
				<option value="<?php echo $opciones2['CLAVE_PERSONAL']?>"><?php echo $opciones2['NOMBRE']?></option>
			<?php endforeach ?>
		</select>
		</div>
		...
		<div id="main-container-loggin-form-submit-center">
			<input type="submit" name="volver" id="main-container-loggin-form-submit" value="Volver" onclick="mandaratras()">
