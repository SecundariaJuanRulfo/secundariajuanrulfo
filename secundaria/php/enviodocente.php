...
$archivo = "https://drive.google.com/open?id=$result->id";
  ...
  echo $m->error->message;
	...
	$consulta="INSERT INTO mensaje_docente (IDMENSAJE, REMITENTE, TABLA, CLAVE_PERSONAL, ASUNTO, MENSAJE, URL, ATENDIDO, ESTATUSBORRAR) VALUES (NULL, '$remitente', 'alumnos', '$docente', '$asunto', '$area','$archivo', '0', '1');";
	$resultado = mysqli_query($con, $consulta);

	$var = "Mensaje Enviado";
				echo"<script type='text/javascript'>
    			alert('".$var."');
    			window.location.href='../php/menualumno.php';
    			</script>";
