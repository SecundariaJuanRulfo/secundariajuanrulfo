...
$archivo = "https://drive.google.com/open?id=$result->id";
  ...
  echo $m->error->message;
	...
	$consulta="INSERT INTO mensaje_docente (IDMENSAJE, REMITENTE, TABLA, CLAVE_PERSONAL, ASUNTO, MENSAJE, URL, ATENDIDO, ESTATUSBORRAR) VALUES (NULL, '$remitente', 'personal', '$docente', '$asunto', '$area','$archivo', '0', '1');";
