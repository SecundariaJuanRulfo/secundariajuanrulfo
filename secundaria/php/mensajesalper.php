...
<head>
	...
	<link rel="stylesheet" type="text/css" href="../css/estilomesajealper.css?n=1">
...
<div id="main-container-posicion">
	...
	<article id="main-container-content">
		<section>
			<form id="main-form" method="POST" action="../php/mostrarmensajepersonal.php">
			<div id="titulo-form">
			<label>Mensajes de Administración</label>
			</div>
			...
			<table id="tabla">
				...
				<tbody id="tabla-body">
				<?php
				$consulta3="SELECT * FROM mensaje_alumno WHERE TABLA='personal' and GRADO='$grado' and GRUPO='$grupo' and ESTATUSBORRAR='1';";
				...
				<tr id="tablaregistro" onclick="mandar(<?php echo $mostrar['IDMENSAJE']?>)">
					...
					<td id="materia" value="<?php echo $mostrar['IDMENSAJE']?>"><?php echo $mostrar['MATERIA']?></td>
