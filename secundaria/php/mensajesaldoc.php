...
<div id="main-container-posicion">
	...
	<article id="main-container-content">
		<section>
			<form id="main-form" method="POST" action="../php/mostrarmensajedocente.php">
			<div id="titulo-form">
			...
			<table id="tabla">
				...
				<tbody id="tabla-body">
				<?php
				$consulta3="SELECT * FROM mensaje_alumno WHERE TABLA='profesores' and GRADO='$grado' and GRUPO='$grupo' and ESTATUSBORRAR='1';";
