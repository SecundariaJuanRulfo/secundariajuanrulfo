...
<div id="main-container-posicion">
	...
	<article id="main-container-content">
		<section>
			<form id="main-form" method="POST" action="../php/mostrarmensajepersonal2.php">
			<div id="titulo-form">
			<label>Mensajes de Administrativos</label>
			</div>
			...
			<table id="tabla">
				<thead>
					<th>Clave</th>
					<th>Cargo de Administración</th>
					<th>Asunto</th>
				</thead>
				<tbody id="tabla-body">
				<?php
				$consulta3="SELECT * FROM mensaje_docente WHERE TABLA='personal' and ESTATUSBORRAR='1';";
				...
				<tr id="tablaregistro" onclick="mandar(<?php echo $mostrar['IDMENSAJE']?>)">
					...
					<td id="materia" value="<?php echo $mostrar['IDMENSAJE']?>">
					<?php 
					$consulta5="SELECT detalles_personal.IDCARGO FROM detalles_personal inner join personal on detalles_personal.IDDETALLEDP= personal.IDDETALLEDP WHERE personal.CLAVE_PERSONAL = ".$mostrar['REMITENTE'].";";
					$resultado5=mysqli_query($con2, $consulta5);
					$mostrar5=mysqli_fetch_array($resultado5);
					$consulta6="SELECT * FROM cargos WHERE IDCARGO = ".$mostrar5[0].";";
					$resultado6=mysqli_query($con2, $consulta6);
					$mostrar6=mysqli_fetch_array($resultado6);
					echo $mostrar6[1];
					?></td>
