...
<div id="main-container-posicion">
	...
	<article id="main-container-content">
		<section>
			<form id="main-form" method="POST" action="../php/mostrarmensajedocente2.php">
			<div id="titulo-form">
			<label>Mensajes de Docentes</label>
			</div>
			...
			<table id="tabla">
				...
				<tbody id="tabla-body">
				<?php
				$consulta3="SELECT * FROM mensaje_personal WHERE TABLA='profesores' and ESTATUSBORRAR='1';";
				...
				<tr id="tablaregistro" onclick="mandar(<?php echo $mostrar['IDMENSAJE']?>)">
					...
					<?php 
					$consulta5="SELECT * FROM cargos WHERE IDCARGO = ".$mostrar['IDCARGO'].";";
