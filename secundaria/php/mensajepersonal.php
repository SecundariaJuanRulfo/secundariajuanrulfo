...
<div id="main-container-posicion">
	...
	<form method="POST" action="../php/envioadmin.php" id="main-form" autocomplete="off" enctype="multipart/form-data">
		<div id="titulo-form">
		...
		<select name="personal" id="personal" class="form-elements" onclick="consultapersonal()">
		...
		<div id="main-container-textarea">
			<textarea name = "area" id="area" placeholder="Escribe tu Mensaje"></textarea>
		</div>
