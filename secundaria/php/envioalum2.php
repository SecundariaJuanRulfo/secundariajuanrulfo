...
$archivo = "https://drive.google.com/open?id=$result->id";
  ...
  echo $m->error->message;
	...
	$consulta="INSERT INTO mensaje_alumno (IDMENSAJE, REMITENTE, TABLA, GRADO, GRUPO, TURNO, MATERIA, ASUNTO, MENSAJE, URL, ATENDIDO, ESTATUSBORRAR) VALUES (NULL, '$remitente', 'personal', '$grado', '$grupo', '$turno', '$materia', '$asunto', '$area','$archivo', '0', '1');";
