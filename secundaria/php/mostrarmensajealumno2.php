...
$con2 = conectar();
    ...
    $consulta="SELECT ASUNTO, MENSAJE, URL, REMITENTE, TABLA FROM mensaje_docente WHERE IDMENSAJE ='$idmensaje' and ESTATUSBORRAR='1';";
	...
	$consulta2="SELECT * FROM $valor[4] WHERE MATRICULA = '$valor[3]';";
...
<div id="main-container-posicion">
	...
	<div id="main-form">
		...
		<div id="main-container-registro-form-materia">
			<label for="remitente" id="etiqueta-remitente">Alumno</label>
			<input type="text" name="materia" id="materia" class="form-elements" disabled="disabled" value="<?php echo $valor3[1];?>">
		</div>
		...
		<div id="main-container-loggin-form-submit-center">
			<input type="submit" name="volver" id="main-container-loggin-form-submit" value="Volver" onclick="mandaratras7()">
