...
$archivo = "https://drive.google.com/open?id=$result->id";
  ...
  echo $m->error->message;
	...
	$consulta="INSERT INTO mensaje_personal (IDMENSAJE, REMITENTE, TABLA, IDCARGO, ASUNTO, MENSAJE, URL, ATENDIDO, ESTATUSBORRAR) VALUES (NULL, '$remitente', 'profesores', '$personal', '$asunto', '$area','$archivo', '0', '1');";
