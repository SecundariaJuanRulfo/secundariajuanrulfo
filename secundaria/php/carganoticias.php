...
<div id="main-container-posicion">
	...
	<form method="POST" action="../php/envionoticia.php" id="main-form" autocomplete="off" enctype="multipart/form-data">
		<div id="titulo-form">
			<label>Carga de Noticias</label>
		</div>
		...
		<div id="main-container-textarea">
			<textarea id="area" name="area" placeholder="Escribe tu Mensaje" required="required"></textarea>
		</div>
